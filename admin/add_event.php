                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Mausham Adhikari</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    ...
                                    <p>
                                        Mausham Adhikari - Web Developer
            ...
            <section class="content">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                    <tr>
                                        <td><a href="pages/examples/invoice.html">01</a></td>
                                        <td>
                                            <div class="img" style="max-width:100%">
                                                <img src="../img/swoyambhu1.jpg" style="width: 38rem;"
                                                    class="card-img-top img-fluid img-thumbnail" alt="image">
                                            </div>
                                        </td>
                                        <td>
                                            <h3 class="">swoyambhu</h3>
                                        </td>
                                        <td>
                                            Kathmandu, Nepal
                                        </td>
                                    ...
                                    <tr>
                                        <td><a href="pages/examples/invoice.html">02</a></td>
                                        <td>
                                            <div class="img" style="max-width:100%">
                                                <img src="../img/lumbini.jpg" style="width: 38rem;"
                                                    class="card-img-top img-fluid img-thumbnail" alt="image">
                                            </div>
                                        </td>
                                        <td>
                    ...
                    <div class="box-footer clearfix">
                        <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left"><i
                                class="fa fa-plus-square"></i> Add Destination</a>
