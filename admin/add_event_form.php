    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            <?php
                ...
                $event_id = $_GET['id'] ?? '';
                // $destination_id = 'id';
                $result = $db->getSingleData('event', $event_id);

                $event =  json_decode($result, true);

            ?>

            <form class="" action="../database/update_event.php" method="POST" enctype='multipart/form-data'>
             ...
             in input field but comment above line FIRST -->
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="eventName" name="eventName"
                            value="<?php echo $event['eventName']; ?>" placeholder="Name" aria-describedby="name-input"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="location" name="location"
                            value="<?php echo $event['location']; ?>" placeholder="Location"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control" id="date" name="date"
                                    value="<?php echo $event['date']; ?>" aria-describedby="date-input" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name='description'
                        value="<?php echo $event['description']; ?>" id="description">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="image" id="imageFile" value="<?php echo $event['image']; ?>" required />
                </div>
